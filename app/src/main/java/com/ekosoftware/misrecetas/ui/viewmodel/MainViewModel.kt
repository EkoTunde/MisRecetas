...
import com.ekosoftware.misrecetas.data.network.UploadingImage
...
class MainViewModel @ViewModelInject constructor(
    ...
    var fetchRecipes = liveData(viewModelScope.coroutineContext + IO) {
        ...
        try {
            ...
            emit(Resource.Failure<List<Recipe>>(e))
        }
    }
