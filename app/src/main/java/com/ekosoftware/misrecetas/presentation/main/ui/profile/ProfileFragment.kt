package com.ekosoftware.misrecetas.presentation.main.ui.profile
...
class ProfileFragment : Fragment() {
    ...
    private val currentUser: User by lazy { userViewModel.user() }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initToolbar()
        populateUI()
        binding.buttonEditImage.setOnClickListener { editImage() }
    }
            ...
            setOnMenuItemClickListener {
                when (it.itemId) {
                    ...
                    R.id.menu_item_sign_out -> {
                        userViewModel.runAuthOperation(AuthOperation.SIGN_OUT)
                        true
                    }
                    R.id.menu_item_delete_user -> {
                        userViewModel.runAuthOperation(AuthOperation.DELETE_USER)
                        true
                    }
                    else -> false
                }
